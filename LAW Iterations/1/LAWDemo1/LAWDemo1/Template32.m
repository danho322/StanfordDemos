...
- (id)initWithDictionary:(NSMutableDictionary*)dict
{
    ...
    if (self) {
        ...
        /*dict = [[[NSMutableDictionary alloc] initWithObjectsAndKeys:instruction, @"instruction",
         stringArray, @"questions",     <- pieces of question, ""(where the label goes), "_"(a space), and text
         choiceArray, @"choices",       <- the choices to pick from
         messageArray, @"messages",     <- the corresponding message to display, "answer" if correct
