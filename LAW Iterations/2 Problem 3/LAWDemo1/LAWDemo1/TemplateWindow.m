...
- (id)initWithDictionary:(NSMutableDictionary*)dict
{
    ...
    if (self) 
    {
        ...
        // Create the ID of the problem
        NSString *fileID = [templateDict objectForKey:@"fileID"];
        self.problemID = [[[UILabel alloc] initWithFrame:CGRectMake(0, 0, window.size.height - 60, 30)] autorelease];
        [problemID setTextColor:[UIColor blackColor]];
        [problemID setBackgroundColor:[UIColor clearColor]];
        [problemID setFont:[UIFont fontWithName:@"Arial" size:25]];
        [problemID setText:fileID];
        [blueBar addSubview:problemID];
        ...
        [problemTitle setTextColor:[UIColor blackColor]];
        ...
        self.problemDesc = [[[UILabel alloc] initWithFrame:CGRectMake(50, blueBar.frame.origin.y + blueBar.frame.size.height + 20, window.size.height - 100, 60)] autorelease];
        [problemDesc setTextColor:[UIColor grayColor]];
        [problemDesc setBackgroundColor:[UIColor clearColor]];
        [problemDesc setFont:[UIFont fontWithName:@"Arial" size:19]];
        [problemDesc setTextAlignment:UITextAlignmentLeft];
        [problemDesc setNumberOfLines:0];
        ...
        [submitButton.layer setCornerRadius:5.f];
