...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.problemArray = [[[NSMutableArray alloc] initWithObjects: problem0, problem1, problem2, nil] autorelease];  //problem0 at the first would add that exercise but difficulties ensue
